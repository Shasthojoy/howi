...
func TestPackageInfo(t *testing.T) {
	tests := []struct {
		...
		{"github.com/digaverse/howi/pkg/errors.packageInfo", "errors", "packageInfo"},
	}
...
func TestStackTraceFrames(t *testing.T) {
	err := WithStackTrace("your error msg")
	// 	github.com/digaverse/howi/pkg/errors/stack-trace_test.go:85 errors.TestStackTraceFrames
